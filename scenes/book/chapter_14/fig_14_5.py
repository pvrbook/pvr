...
# Lights
lightParms = {
    "position" : V3f(-2.0, 0.0, 0.0), 
    "intensity" : Color(12.0),
    "rotation" : V3f(0.0, -90.0, 0.0),
    "fov" : 90.0,
    "num_samples" : 128
}
light = pvr.lights.makeSpotLight(renderer, lightParms, lightResMult, 
                                 OtfTransmittanceMapOccluder)
light.setFalloffEnabled(True)
light.setConeAngles(radians(45), radians(20))
...
# Save result
renderer.saveImage("conelight.png")
renderer.saveImage("conelight.exr")
