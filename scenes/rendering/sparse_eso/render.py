...
primParams = {
    ...
    "T"                              : V3f(1.0, 0.0, 0.0), 
    "v"                              : V3f(0.0),
    "density"                        : V3f(200.0) * (1.0 / instanceMult),
    "thickness"                      : 0.1,
    # Base per-prim
    "instance_radius"                : 0.002, 
    "num_points"                     : int(800000 * instanceMult), 
    "fill"                           : 1, 
    # Noise per-prim
...
modeler.setSparseBlockSize(SparseBlockSize.Size8)
...
volume.setUseEmptySpaceOptimization(True)
