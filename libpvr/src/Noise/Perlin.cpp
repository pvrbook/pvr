...
/*! \file Perlin.cpp
  Contains implementations of Perlin noise
 */
...
namespace {
  ...
  // Instantiate to force init to run
  static ForceInit initPerlin;
...
double noise(double x, double y, double z) 
{
  ...
  int BA = p[B]     + Z; 
  int BB = p[B + 1] + Z;
  // Finally add blended results from 8 corners of cube
